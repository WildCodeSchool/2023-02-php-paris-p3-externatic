 ...
 */
final class Version20230706115024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE application (id INT AUTO_INCREMENT NOT NULL, candidate_id INT NOT NULL, offer_id INT NOT NULL, status VARCHAR(100) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_A45BDDC191BD8781 (candidate_id), INDEX IDX_A45BDDC153C674EE (offer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, title VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, start_at DATETIME NOT NULL, contract VARCHAR(150) NOT NULL, work_from_home VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, experience VARCHAR(150) NOT NULL, min_salary INT NOT NULL, max_salary INT DEFAULT NULL, location VARCHAR(255) NOT NULL, interview_process LONGTEXT NOT NULL, picture VARCHAR(255) DEFAULT NULL, number INT DEFAULT NULL, INDEX IDX_29D6873E979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

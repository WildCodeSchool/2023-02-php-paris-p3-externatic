 ...
 */
final class Version20230613130621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE application (id INT AUTO_INCREMENT NOT NULL, candidate_id INT NOT NULL, offer_id INT NOT NULL, status VARCHAR(100) NOT NULL, created_at DATETIME DEFAULT NULL, INDEX IDX_A45BDDC191BD8781 (candidate_id), INDEX IDX_A45BDDC153C674EE (offer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE candidate (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, favorite_id INT DEFAULT NULL, firstname VARCHAR(100) NOT NULL, lastname VARCHAR(100) NOT NULL, birthdate DATE NOT NULL, location VARCHAR(255) NOT NULL, phone VARCHAR(100) DEFAULT NULL, resume VARCHAR(150) NOT NULL, introduction TEXT NOT NULL, title VARCHAR(150) NOT NULL, experience VARCHAR(100) DEFAULT NULL, linkedin VARCHAR(255) DEFAULT NULL, picture VARCHAR(150) DEFAULT NULL, portfolio VARCHAR(255) DEFAULT NULL, github VARCHAR(255) DEFAULT NULL, visible TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_C8B28E44A76ED395 (user_id), INDEX IDX_C8B28E44AA17481D (favorite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, favorite_id INT DEFAULT NULL, name VARCHAR(150) NOT NULL, type VARCHAR(100) NOT NULL, sector VARCHAR(150) NOT NULL, presentation TEXT NOT NULL, logo VARCHAR(150) NOT NULL, sales_revenue INT DEFAULT NULL, creation_year DATE DEFAULT NULL, location VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_4FBF094FA76ED395 (user_id), INDEX IDX_4FBF094FAA17481D (favorite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, title VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, start_at DATETIME NOT NULL, contract VARCHAR(150) NOT NULL, work_from_home VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, experience VARCHAR(150) NOT NULL, min_salary INT NOT NULL, max_salary INT DEFAULT NULL, location VARCHAR(255) NOT NULL, interview_process LONGTEXT NOT NULL, picture VARCHAR(255) DEFAULT NULL, INDEX IDX_29D6873EA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, candidate_id INT DEFAULT NULL, company_id INT DEFAULT NULL, role VARCHAR(100) NOT NULL, login VARCHAR(255) NOT NULL, password VARCHAR(150) NOT NULL, UNIQUE INDEX UNIQ_8D93D64991BD8781 (candidate_id), UNIQUE INDEX UNIQ_8D93D649979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
